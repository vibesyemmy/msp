$(document).ready(function() {
    ...
    $("#contact-form [type='submit']").click(function(e) {
        ...
        post_data = {'userChecking':user_checking, 'name':user_name, 'email':user_email, 'company':user_company, 'phone':user_phone, 'message':user_message};
       
        // Ajax post data to server
        $.post('/api/notify', post_data, function(response){  
