...
$(document).ready(function(){
    ...
    $('.slideshow-home-left').vegas({
        slides: [
            { src: 'public/img/left-1.jpg' },
            { src: 'public/img/left-2.jpg' },
            { src: 'public/img/left-3.jpg' },
        ],
    ...
    $('.slideshow-home-right').vegas({
        slides: [
            { src: 'public/img/right-1.jpg' },
            { src: 'public/img/right-2.jpg' },
            { src: 'public/img/right-3.jpg' },
        ],
